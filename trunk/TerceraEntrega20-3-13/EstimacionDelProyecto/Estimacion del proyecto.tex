...
Una vez vez hecho esto, calcularemos el factor de ajuste para obtener los puntos de función ajustados. Entonces estaremos en condiciones de estimar y obtener unos resultados que se podrán aplicar al proyecto. Par ello utilizaremos la herramienta \texttt{COCOMO II.2000.4}, que se puede encontrar en 
...
\vspace{0.35cm}
\rhead{\bfseries Estimación del proyecto}
...
\vspace{0.35cm}
\hspace{3.5cm}
\scalebox{0.5}{\includegraphics{PFCOCOMOpeso}} 
\vspace{0.35cm}
...
\vspace{0.35cm}
\hspace{2.9cm}
\scalebox{0.55}{\includegraphics{PFCOCOMO}} 
\vspace{0.35cm}
...
\vspace{0.35cm}
\hspace{-2.8cm}
\scalebox{0.45}{\includegraphics{COCOMOTODO2}} 
\vspace{0.35cm}
...
\vspace{0.35cm}
\hspace{-2.7cm}
\scalebox{0.42}{\includegraphics{COCOMOTODO1}} 
\vspace{0.35cm}
