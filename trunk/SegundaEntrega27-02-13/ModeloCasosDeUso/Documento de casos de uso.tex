...
%LOG IN
	...
	\subsection{Log in}		
			...
			\item \textbf{Curso típico de eventos:} 	\\
				...
				\textbf{3.} Introduce el usuario y  la clave. & \textbf{4.} Si es correcto presenta el programa iniciado.\\ \hline
			\end{tabular}
			\\
...
%ACCEDER A LA FICHA DE UN EMPLEADO
	...
	\subsection{Acceder a la ficha de un empleado}		
			...
			\item \textbf{Visión general:}  En el buscador introduce el nombre deseado. y se le muestra la ficha del empleado(si existe). \\
...
%ANULAR RESERVAS
	...
	\subsection{Anular reservas}
		\begin{itemize}
			\item \textbf{Actor:} Recepcionista, maître, jefe.
			\item \textbf{Descripción:} Desde la pantalla de ver reservas, se permite anular la reserva deseada. 		
		\end {itemize}
