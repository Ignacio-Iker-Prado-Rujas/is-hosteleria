...
\section{Prioridad de los riesgos}
		En esta sección se ordenan los riesgos según su prioridad y se eligen aquellos riesgos que van a ser tratados.\\ \ \\
			...
			\begin{tabular}{|p{12cm}|}
				...
				\textbf{10.} La interfaz de usuario es demasiado dificil de construir. \\ \hline
				\textbf{11.} El cliente considera que la interfaz es dificil de usar.		\\ \hline
			...
			\begin{tabular}{|p{12cm}|}
				...
				\textbf{19.} Baja definitiva de algun miembro del equipo por enfermedad.\\ \hline 
				\textbf{20.} Abandono de la asignatura por parte de algún miembro del equipo.\\ \hline
				\textbf{21.} Abandono del proyecto por algun miembro del equipo. \\ \hline
				\textbf{22.} Abandono de la carrera por algun miembro del equipo. \\ \hline
