...
\section{Planificaciones y presupuestos poco realistas}
	...
	\subsection*{Pérdidas insubsanables}
		\begin{itemize}
			\item \textbf {Probabilidad: }Ocasional.
			\item \textbf {Consecuencia: }Crítica. Cambio en la planificación del proyecto y empeoramiento de los resultados.
		\end{itemize}
...
\section{Prioridad de los riesgos}
		En esta sección se ordenan los riesgos según su prioridad y se eligen aquellos riesgos que van a ser tratados.\\ \ \\ 
			...
			\begin{tabular}{|p{12cm}|}
				...
				\textbf{20.} Baja definitiva de algún miembro del equipo por enfermedad.\\ \hline 
				\textbf{21.} Abandono de la asignatura por parte de algún miembro del equipo.\\ \hline
				\textbf{22.} Abandono del proyecto por algún miembro del equipo. \\ \hline
				\textbf{23.} Abandono de la carrera por algún miembro del equipo. \\ \hline
				\textbf{24.} Las funciones son ineficientes.\\ \hline
				\textbf{25.} Poca calidad de las funciones y propiedades realizadas. \\ \hline
				\textbf{26.} Las distintas partes del proyecto no cumplen con su cometido \\ \hline
				\textbf{27.} Dificultad para hacer que las distintas funciones del proyecto se coordinen entre ellas. \\ \hline
				\textbf{28.} El producto no funciona debidamente en la plataforma en que se quiere usar. \\ \hline
				\textbf{29.} Falta de recursos para el desarrollo de la interfaz. \\ \hline
				\textbf{30.} El cliente cambia de opinión acerca de lo que debe hacer el proyecto. \\ \hline
				\textbf{31.} Falta de recursos para realizar el proyecto \\ \hline
			\end{tabular}
			...
			\begin{tabular}{|p{12cm}|}
				...
				\textbf{32.} Baja del supervisor del proyecto.\\ \hline 
				\textbf{33.} El lenguaje no permite realizar todas las funciones.\\ \hline
				\textbf{34.} Las librerías de java no son eficientes para nuestro proyecto. \\ \hline
