...
\chapter{Estrategia de gestión del riesgo}
	...
	Los detalles de esta parte se encuentran en el documento \textt{Gestión de Riesgos}.\\
...
\chapter{Recursos del proyecto}
	...
	\section{Hardware y software}
		...
		\subsection{Recursos de entorno}
			...
			También se usó el entorno de programación Eclipse, utlizando el plug-in para \LaTeX\  \textt{TeXlipse}. 
		...
		\subsection*{Recursos de entorno}
			\begin{itemize}
				...
				\item \textb{ArgoUML}
					...
					\end{itemize}
				\item \textb{Microsoft Power Point}
				  	\begin{itemize}
