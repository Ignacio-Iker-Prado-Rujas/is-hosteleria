...
\section{Supuestos y dependencias}	
	El software estará enfocado para ser utilizado en dispositivos con sistema operativo Android o Windows, aunque al estar escrito en Java esto nos permitira cambiar de sistema operativo sin demasiadas modificaciones debido a que la implementación cambiará solo en casos muy especificos, así que podriamos decir que depende relativamente del sistema operativo.  Por el contrario, si que va a depender mucho del hardware, puesto que necesitará sincronizarse con un sistema central que organice y distribuya toda la información de los dispositivos de los empleados, por tanto necesitaremos un procesador muy rapido que organice todo. También será necesario un servidor interno que distribuya la información entre los distintos dispositivos.	\\
...
\item \textbf{Anular reserva} %Anular reserva
	...
	\item \textbf{Ver Menú} %Ver Menú
		...
		\begin{itemize}
			...
			\item \textbf{Origen: } Tablet o terminal con sesión de maître, jefe o recepcionista.
		...
		\begin{itemize}
			...
			\item \textbf{Origen: }Tablet o terminal de maître, jefe o recepcionista
		...
		\begin{itemize}
			...
			\item \textbf{Origen: }Generalmente terminal de recepcionista, también tablet o terminal del jefe o del maître
		...
		\begin{itemize}
			...
			\item \textbf{Origen: }Tablet o Terminal conectado al sistema( Maître, Jefe o recepcionista)
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Por el elevado coste, que lo hace inviable, no podemos instalar un hardware en cada habitación que permita crear pedidos y reservar en el restaurante a los propios clientes.
...
\begin{itemize}
	...
	\item La conexión de las tablets por Wi-Fi estará cifrada. El acceso directo estará controlado por el login, que exige usuario y contraseña para conectarse al sistema.
\end{itemize}
