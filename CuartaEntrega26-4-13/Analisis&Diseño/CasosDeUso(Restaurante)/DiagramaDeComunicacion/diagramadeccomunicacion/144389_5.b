class PlatosPanel
!!!153093.java!!!	PlatosPanel(inout rest : Restaurante)
...
!!!153221.java!!!	PlatosPanel(inout rest : GUIController)
		
!!!153349.java!!!	PlatosPanel(in i : int, inout rest : GUIController)
		this.menu = rest.getMenu();
