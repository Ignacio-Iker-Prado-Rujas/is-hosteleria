...
\part{Actividades de la GCS}
	...
	\section{Control de la configuración}
		\subsection{Petición de cambios}
		\subsection{Evaluación de cambios}
		\subsection{Aprobación o desaprobación de cambios}
		\subsection{Implementación de cambios}
	\section{Contabilidad de estado de configuración}
	\section{Auditorias y revisiones de la configuración} 
...
%%% PARTE 4: PLANIFICACIÓN DE LA GCS__________________________________________________________________________________________
\part{Planificaciones de la GCS}
...
%%% PARTE 6: MANTENIMIENTO DEL PLAN DE GCS__________________________________________________________________________________
\part{Mantenimiento del plan de GCS}
...
3. Actividades de la GCS
	...
	3.2 Control de la configuración
	...
	3.4 Auditorias y revisiones de la configuración 
	3.5 Control de interfaz
	3.6 Control de la subcontratación/compra
