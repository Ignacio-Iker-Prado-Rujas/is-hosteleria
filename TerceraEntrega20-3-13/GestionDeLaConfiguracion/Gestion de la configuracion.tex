...
\part{Actividades de la GCS}
	\section{Identificación de la configuración}
		\subsection{Identificación de ECSs}
			%En subsubsection se pone el nombre del ECS
			\subsubsection{}
			\begin{itemize}	
				\item{Descripción:}
		...
		\begin{itemize}
			\item Objetos básicos
			\begin{itemize}	
				\item \texttt{Documento de Casos de Uso}.
				\item Introducción  del documento \texttt{Especificación de Requisitos}.
				\item Descripción General del documento \texttt{Especificación de Requisitos}.
				\item Requisitos Específicos del documento \texttt{Especificación de Requisitos}. 
				\item Introducción del documento anexo \texttt{Plan de Proyecto}.
				\item Estimaciones del documento anexo \texttt{Plan de Proyecto} y documento \texttt{Estimación del Proyecto}.
				\item Planificación temporal y Recursos del Proyecto, del documento anexo \texttt{Plan de Proyecto}.
				\item Documento anexo \texttt{Gestión de Riesgos}.
				\item Documento anexo \texttt{Glosario}.
				\item Documento \texttt{Garantía de Calidad}.
				\item Documento \texttt{Gestión de la Configuración}.
			\end{itemize}
			\item Objetos compuestos
				\begin{itemize}
					\item Primera entrega
					\item Segunda entrega
					\item Tercera entrega
				\end{itemize}
		\end{itemize}
