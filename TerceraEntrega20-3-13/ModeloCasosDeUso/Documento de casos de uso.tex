...
%MODIFICAR MENU
		...
		\subsection{Modificar menú}
			...
			\begin{tabular}{|p{6cm}||p{6cm}|}
				\hline
				\textbf{Acción del actor} & \textbf{Respuesta del sistema} \\ \hline \hline
				\textbf{3.} Selecciona la opción ``modificar menú''. & 
				\textbf{4.} Muestra las siguientes opciones: 
					\textit{Añadir plato. Modificar plato. Eliminar plato}. \\ \hline
				\textbf{5.} Selecciona una de las opciones.	& 
				\textbf{6.} Si se seleccionó \textit{Añadir plato}, ver sección ``Añadir plato''. 
