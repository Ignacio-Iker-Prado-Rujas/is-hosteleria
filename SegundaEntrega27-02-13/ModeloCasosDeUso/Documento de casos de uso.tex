...
\part{Casos de uso} %%% PARTE 2: CASOS DE USO %%%_____________________________________________________________________________________
...
%GESTIONAR EMPLEADOS
	\newpage
	\subsection \textbf{Gestionar Empleados} \\ 
...
%ACCEDER A LA FICHA DE UN EMPLEADO
	...
	\subsection\textbf{Acceder a la ficha de un empleado}		%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)
			\begin{itemize}
...
%AÑADIR CLIENTE
	\newpage
	\subsection \textbf{Añadir cliente} \\		%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)
...
%VER FICHA DE CLIENTE
	...
	\subsection \textbf{Ver ficha de cliente}		%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)
			\begin{itemize}
			\item \textbf{Actor:} Jefe, recepcionista, maître.
			\item \textbf{Propósito: } Acceder a la ficha de un cliente.
			\item \textbf{Visión general:} El actor accede al programa de gestión de empleados desde su ordenador. Después de introducir su nombre de usuario y su contraseña, accede a la base de datos de los clientes. Busca al cliente por nombre y/o apellidos . Tras haber acceder a su ficha, consulta los datos que desee. Cierra la aplicación. 
			\item \textbf{Curso típico de eventos:} 	\\
				\begin{tabular}{|p{6cm}||p{6cm}|}
				\hline
				\textbf{Acción del actor} & \textbf{Respuesta del sistema} \\ \hline \hline
...
%EDITAR CLIENTE
	...
	\subsection \textbf{Editar cliente} 	%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)		
			\begin{itemize}
			\item \textbf{Actor:} Jefe, recepcionista.
			\item \textbf{Propósito: } Editar la ficha de un cliente.
			\item \textbf{Visión general:} El actor accede al programa de gestión de empleados desde su equipo. Después de introducir su nombre de usuario y su contraseña, accede a la base de datos de los clientes. Busca al cliente por nombre y/o apellidos. Se muestra la ficha del cliente, dando la opción de editar los campos que sean necesarios. Comprueba que las ediciones son correctas. Cierra la aplicación. 
			\item \textbf{Curso típico de eventos:} 	\\
				\begin{tabular}{|p{6cm}||p{6cm}|}
				\hline
				\textbf{Acción del actor} & \textbf{Respuesta del sistema} \\ \hline \hline
...
%DAR DE BAJA CLIENTE
	\newpage
	\subsection \textbf{Dar de baja cliente} 	%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)		
			\begin{itemize}
			\item \textbf{Actor:} Jefe, recepcionista.
...
%ORGANIZAR TAREAS DE LIMPIEZA		
	...
	\subsection \textbf{Organizar tareas de limpieza}				%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)
			\begin{itemize}
...
\subsection \textbf{Revisión de limpieza}
			\begin{itemize}
			\item \textbf{Actor: }Jefe de limpieza.
...
%CONSULTAR TAREAS
	...
	\scalebox{0.9}{\includegraphics{Limpieza}} 
		\subsection\textbf{Consultar tareas}				
				\begin{itemize}
...
%CONFIRMAR LIMPIEZA DE HABITACION
		...
		\subsection \textbf{Confirmar limpieza de habitación}
			\begin{itemize}
			\item \textbf{Actor: }Personal de limpieza.
...
%INFORMAR DE INCIDENCIAS
		...
		\subsection \textbf{Informar de incidencias}	
			\begin{itemize}
...
%CONSULTAR TAREAS DE MANTENIMIENTO
		...
		\subsection \textbf{Consultar tareas de mantenimiento}
			\begin{itemize}
...
%RESERVAR MESA
		...
		\subsection\textbf{Reservar mesa} 
			\begin{itemize}
...
%ANULAR RESERVA
		...
		\subsection\textbf{Anular reserva}
			\begin{itemize}
			\item \textbf{Actor:} Camareros, maître, recepcionista, chef, cocineros.
...
%GENERAR UN PEDIDO PARA UNA MESA
		...
		\subsection \textbf{Generar un pedido para una mesa}
			\begin{itemize}
...
%MODIFICAR UN PEDIDO
	...
	\subsection \textbf{Modificar un pedido}
			\begin{itemize}
...
%CANCELAR UN PEDIDO
		...
		\subsection\textbf{Cancelar un pedido}
			\begin{itemize}
			\item \textbf{Actor:} Camareros, maître.
...
%GENERAR FACTURA A UN CLIENTE
		...
		\subsection \textbf{Generar factura a un cliente}
			\begin{itemize}
			\item \textbf{Actor:} Camareros, maître.
...
%VER CUENTA DIARIA DE LA CAJA DE RECEPCIÓN.
	...
	\subsection \textbf{Ver cuenta diaria de la caja de recepción}
		\begin{itemize}
...
%VER CUENTA DIARIA DE LA CAJA DEL RESTAURANTE.
	...
	\subsection \textbf{Ver cuenta diaria de la caja del restaurante}
		\begin{itemize}
			\item \textbf{Actor:} Jefe.
...
%CONSULTAR LIBRO DIARIO
	...
	\subsection \textbf{Consultar libro diario}
		\begin{itemize}
			\item \textbf{Actor:} Jefe.
...
%CONSULTAR LIBRO MAYOR
	...
	\subsection \textbf{Consultar libro mayor}
		\begin{itemize}
			\item \textbf{Actor:} Jefe.
...
%VER HABITACIONES
	...
	\subsection \textbf{Ver habitaciones}
		\begin{itemize}
...
%RESERVAR HABITACION
	\subsection \textbf{Reservar habitacion}
		\begin{itemize}
			\item \textbf{Actor:} Recepcionista, maître, jefe.
...
%ANULAR RESERVAS
	...
	\subsection \textbf{Anular reservas}
		\begin{itemize}
			\item \textbf{Actor:} Recepcionista, maître, jefe.
...
%GENERAR FACTURA DEL HOTEL
	...
	\subsection \textbf{Generar factura del hotel}
		\begin{itemize}
			\item \textbf{Actor:} Recepcionista, maître, jefe.
...
%AÑADIR EMPLEADO
	...
	\subsection \textbf{Añadir un nuevo empleado}		%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)
			\begin{itemize}
			\item \textbf{Actor:} Jefe.
...
%DAR DE BAJA A UN EMPLEADO
	...
	\subsection \textbf{Dar de baja a un empleado}		%Esta es la plantilla para la descripción de un caso de uso expandido (que es importante y requiere detalle)
			\begin{itemize}
...
%MODIFICAR LA FICHA DE UN EMPLEADO
	...
	\subsection\textbf{Modificar la ficha de un empleado}		
			\begin{itemize}
			\item \textbf{Actor:} Jefe.
...
%VER CURRICULUM DE EMPLEADO
	...
	\subsection \textbf{Ver el currículum de un empleado}		
			\begin{itemize}
			\item \textbf{Actor:} Jefe.
...
%DAR DE BAJA A UN CLIENTE
	...
	\subsection \textbf{Dar de baja a un cliente}
			\begin{itemize}
...
%EDITAR UN CLIENTE
	...
	\subsection\textbf{Modificar la ficha de un cliente}		
			\begin{itemize}
			\item \textbf{Actor:} Jefe.
...
%COMPROBAR DISTRIBUCIÓN Y NÚMERO DE LAS MESAS EN EL COMEDOR
		...
		%\begin{itemize} 	
		\subsection \textbf{Comprobar distribución y número de las mesas en el comedor}
			\begin{itemize}
...
%MODIFICAR DISTRIBUCIÓN DEL RESTAURANTE
		...
		\subsection \textbf{Modificar distribución del restaurante}
			\begin{itemize}
...
%REALIZAR RECUENTO DE ALIMENTOS
	...
	\subsection \textbf{Realizar recuento de alimentos}
			\begin{itemize}
...
%MODIFICAR MENU
		...
		\subsection\textbf{Modificar menú}
			\begin{itemize}
			\item \textbf{Actor:} Maître, Jefe, Jefe de cocina.
...
%EDITAR HABITACIONES
	\subsection \textbf{Editar habitaciones}
		\begin{itemize}
			\item \textbf{Actor:} Recepcionista, maître, jefe.
