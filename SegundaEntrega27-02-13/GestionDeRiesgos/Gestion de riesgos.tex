...
\part{Gestión del riesgo}
	...
	\section*{Baja temporal de algún miembro del equipo por enfermedad}
		\begin{itemize}
			\item \textbf {Indicios de que se produzca: }
			\item \textbf {Acción de contingencia: }Reparto equitativo de las tareas entre el resto del equipo. 
			\item \textbf {Prevencion: }
			\item \textbf {Mitigacion: }
		\end{itemize}
	...
	\section*{Los programas proporcionados son muy difíciles de usar y poco efectivos}
		\begin{itemize}
			\item \textbf {Indicios de que se produzca: }Hay poca visibilidad del producto 
			\item \textbf {Acción de contingencia: }
			\item \textbf {Prevencion: }
			\item \textbf {Mitigacion: }
		\end{itemize}
...
\subsection*{El producto no se ajusta a lo que el cliente necesita por falta de comunicación}			% Hay que rellenar los siguientes campos de cada riesgo
	\begin{itemize}
		\item \textbf {Prioridad: }Medio-alta.
		\item \textbf {Probabilidad: }Probable.
